...
ALTER TABLE blog_posts_seo ADD postSlug varchar(255) NOT NULL AFTER `postTitle`;
ALTER TABLE blog_posts_seo ADD published tinyint(1) NOT NULL AFTER `postDate`;
